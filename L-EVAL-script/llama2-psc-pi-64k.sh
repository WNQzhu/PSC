CUDA_VISIBLE_DEVICES=6 python3  Baselines/llama2-ft-psc-pi-64k.py \
       --scale 7b \
       --max_length 64k \
       --metric exam_eval \
       --model_path /mnt/wnq/model/meta-llama/llama2-7b-hf \
       --task_path LEval-data/Closed-ended-tasks/coursera.jsonl \
       --peft_model /mnt/wnq/new/rec/phase/mlora_test.7b.lr-2e-4.bs4.3000step.pi.64k.phase/checkpoint-1500 
